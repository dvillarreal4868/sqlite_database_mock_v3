"""Tests for rebuild_registry.ingest.genomics."""
...
class TestIngestGenomics:
    ...
    def test_genomics_attributes(self, db_conn, tmp_h5):
        ...
        assert cov == 30
        assert ref == "GRCh38"
        assert vcf == "/genomics_archive/P001/variants/"
        assert bam == "/genomics_archive/P001/aligned/"
        assert gpath == "/genomics/wgs_2026-07-15"
